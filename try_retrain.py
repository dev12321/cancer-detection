...
def predict_image_class(imagePath, labelPath = LABEL_PATH):
    ...
    with tf.Session() as sess:
        ...
        for node_id in top_k:
            ...
            ansres['label'] = filter_delimiters(labels[node_id])
            ansres['score'] = str(predictions[node_id])
            finalres.append(ansres)
